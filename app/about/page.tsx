    ...
    <div className="pt-24">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* Managing Director */}
          <div className="mb-16">
            <h3 className="text-3xl font-heading font-bold text-purple mb-8 text-center">
              Managing Directors
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-3xl mx-auto">
              {executiveOfficers.md.map((officer, index) => (
                <div
                  key={index}
                  className="relative bg-white rounded-2xl p-8 pb-16 shadow-md hover:shadow-xl hover:border-purple-600 border-4 border-purple/30 hover:scale-105 transition-all duration-300 flex flex-col"
                >
                  <div className="aspect-square w-full mb-6 overflow-hidden rounded-md">
                    <Image
                  ...
                  <p className="text-gray-600 text-left text-md grow">
                    {officer.blurb}
                  </p>
                  <Link
